...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/Nadim-Ahamed/NadimAhamed/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf ToxicBomber && git clone https://github.com/nadim11223345/Nadim.py > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd Sms-Bomber && python S-Bomb.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Nadim Ahamed.                \033[94m│".center(columns+15))
